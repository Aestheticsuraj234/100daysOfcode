...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 space-x-2 rounded-lg">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="#" className="flex items-center">
                <img src="/avatar.png" className="h-8 mr-3" alt="SigmaDeveloper Logo" />
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="#/" className="hover:underline">SigmaDeveloper</a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://github.com/themesberg/SigmaDeveloper" className="hover:underline ">Github</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://SigmaDeveloper.com/" className="hover:underline">SigmaDeveloper™</a>. All Rights Reserved.
        </span>
