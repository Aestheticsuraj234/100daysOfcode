...
<nav className="bg-indigo-300 border-gray-200 px-2 sm:px-4 py-2.5 rounded ">
  <div className="container flex flex-wrap items-center justify-between mx-auto">
  <a href="https://flowbite.com/" className="flex items-center">
     
      <span className="self-center text-xl font-bold text-gray-900  whitespace-nowrap dark:text-white">SIGMA DEVELOPER</span>
  </a>
